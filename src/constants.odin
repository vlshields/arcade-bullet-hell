...
GRUNT_DEATH_FRAMES :: 8
GRUNT_DEATH_FRAME_DUR :: 0.07 // s
GRUNT_CORPSE_MAX :: 16
...
SNEAK_FRAME_H :: 16 // px
SNEAK_FRAMES :: 6
SNEAK_ANIM_FPS :: 8.0 // frames/s
SNEAK_DEATH_FRAMES :: 5
SNEAK_DEATH_FRAME_DUR :: 0.07 // s
SNEAK_CORPSE_MAX :: 16
...
SHRINK_BOMB_FIRE_SUPPRESS :: 0.5 // s
...
HP_BAR_MARGIN :: 6 // px
STATUS_BAR_GAP :: 6 // px
STATUS_BAR_NUM_FONT_SIZE :: 10 // px
STATUS_BAR_NUM_GAP :: 4 // px

TIMER_FONT_SIZE :: 16 // px

VICTORY_TITLE_FONT_SIZE :: 24 // px
VICTORY_TIME_FONT_SIZE :: 16 // px
...
GAME_OVER_TITLE_FONT_SIZE :: 36 // px
GAME_OVER_TITLE_Y :: 130 // px
GAME_OVER_TITLE_DROP_FROM_Y :: -60.0 // px (start above screen, ease into place)
GAME_OVER_ANIM_DUR :: 1.2 // s
GAME_OVER_INPUT_DELAY :: 1.5 // s
GAME_OVER_OVERLAY_ALPHA :: 220 // alpha [0..255]
GAME_OVER_PROMPT_FONT_SIZE :: 12 // px
GAME_OVER_PROMPT_Y :: 220 // px
...
LEVEL2_WAVES_TO_VICTORY :: 7

LEVEL4_GRUNT_FIRE_INTERVAL :: 1.5 // s
LEVEL4_WAVES_TO_VICTORY :: 5

PILLAR_MAX :: 6 // count (storage cap; round 1 uses 4, round 2 uses 6)
PILLAR_R1_COUNT :: 4 // count
PILLAR_R2_COUNT :: 6 // count
PILLAR_HP :: 50 // hp
...
PILLAR_R1_BULLETS_PER_BURST :: 3
PILLAR_R2_BULLETS_PER_BURST :: 5
...
MISSION_TITLE_SLIDE_DIST :: 220.0 // px (off-screen offset the title/subtitle ease in from)
